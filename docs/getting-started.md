...
Quick reference tables for index codes (Sector 33, Topix‑17, Market Segments, Style/Size, REIT) are available in `docs/ml/dataset.md` under “Indices (Market & Sector) Features”.
