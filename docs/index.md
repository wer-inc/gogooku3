...
- [**📡 データ取得運用ノート**](ml/dataset_ingestion_strategy.md) - 軸選択・差分検知・命名整備
- [**📦 日次マージン仕様（dmi_）**](ml/dataset.md#8-日次マージンmarketsdaily_margin_interest特徴接頭辞-dmi) - T+1/as‑of結合・列一覧・有効化
...
- [**ATFT ドキュメント集約**](ml/atft/index.md) - ATFT 関連ノート一覧
- [**データセット仕様**](ml/dataset.md) - 列仕様・生成フロー
- [**データ取得運用ノート**](ml/dataset_ingestion_strategy.md) - 軸選定・差分検知・命名整備
...
| 2025-10-20 | 旧 reports/* コンテンツをアーカイブ化 | Claude |
