#!/usr/bin/env python3
"""
Check that a generated dataset conforms to docs/DATASET.md feature contract.
...
def required_columns() -> dict[str, set[str]]:
    mkt = {
        ...
        'mkt_vol_20d','mkt_atr_14','mkt_natr_14','mkt_bb_pct_b','mkt_bb_bw',
    ...
    cross = {'beta_60d','alpha_1d','alpha_5d','rel_strength_5d','trend_align_mkt','alpha_vs_regime','idio_vol_ratio'}
    flow = {
        ...
        'flow_smart_idx','flow_smart_mom4','flow_shock_flag','flow_impulse','flow_days_since',
    }
    stmt = {
        'stmt_yoy_sales','stmt_yoy_op','stmt_yoy_np','stmt_opm','stmt_npm',
        'stmt_progress_op','stmt_progress_np','stmt_rev_fore_op','stmt_rev_fore_np','stmt_rev_fore_eps','stmt_rev_div_fore',
        'stmt_roe','stmt_roa','stmt_change_in_est','stmt_nc_flag','stmt_imp_statement','stmt_days_since_statement',
    }
    targets = {'target_1d','target_5d','target_10d','target_20d','target_1d_binary','target_5d_binary','target_10d_binary'}
