...
try:
    from gogooku3.data.loaders.production_loader_v2_optimized import (
        ProductionDatasetOptimized,
    )
    ...
    try:
        from src.data.loaders.production_loader_v2_optimized import (
            ProductionDatasetOptimized,
        )
        from src.data.safety.cross_sectional_v2 import (
            CrossSectionalNormalizerV2 as CrossSectionalNormalizer,
        )
