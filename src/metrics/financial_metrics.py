...
class FinancialMetrics:
    ...
    def compute_information_coefficient(
        self,
        predictions: np.ndarray | torch.Tensor | pd.Series,
        targets: np.ndarray | torch.Tensor | pd.Series,
    ...
    def compute_decile_analysis(
        self,
        predictions: np.ndarray | torch.Tensor | pd.Series,
        returns: np.ndarray | torch.Tensor | pd.Series,
        dates: np.ndarray | pd.Series,
        return_daily: bool = False
    ) -> dict[str, Any]:
        """
    ...
    def compute_multi_horizon_metrics(
        self,
        predictions_dict: dict[str, np.ndarray | torch.Tensor],
        targets_dict: dict[str, np.ndarray | torch.Tensor],
        dates: np.ndarray | pd.Series,
        return_daily: bool = False
    ) -> dict[str, Any]:
        """
