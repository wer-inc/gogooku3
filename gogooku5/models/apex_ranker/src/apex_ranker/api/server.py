...
def _extract_feature_columns(config: dict, config_path: Path) -> list[str]:
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    feature_cols = _extract_feature_columns(config, settings.config_path)
