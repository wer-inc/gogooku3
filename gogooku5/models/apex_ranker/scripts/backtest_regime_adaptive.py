...
ensure_import_paths()
from apex_ranker.backtest import (  # noqa: E402
    CostCalculator,
    OptimizationConfig,
    Portfolio,
    Trade,
...
from apex_ranker.backtest.inference import (  # noqa: E402
    BacktestInferenceEngine,
    compute_weight_turnover,
)
from apex_ranker.data.loader import load_backtest_frame  # noqa: E402
from apex_ranker.realtime_regime import RealtimeRegimeCalculator  # noqa: E402

# Import regime detection
from apex_ranker.regime_detection import DefensiveRiskManager  # noqa: E402
from apex_ranker.utils import load_config  # noqa: E402
from backtest_smoke_test import (  # noqa: E402
    build_daily_lookup,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        default="models/apex_ranker/configs/v0_base.yaml",
