...
class LightGBMFinancialBaseline:
    ...
    def _prepare_features(self, data: Union[pd.DataFrame, pl.DataFrame]) -> pd.DataFrame:
        """特徴量を準備"""
        # Pandasに変換
    ...
    def fit(self, data: Union[pd.DataFrame, pl.DataFrame]) -> 'LightGBMFinancialBaseline':
        """
